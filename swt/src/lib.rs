...
const DAILY_STEP_CONVERSION_LIMIT: u64 = 10_000;
...
pub struct Contract {
    ...
    token: FungibleToken,
    steps_from_tge: U64,
    daily_limits: LookupMap<AccountId, (u64, u64)>,
}
...
impl Contract {
    ...
    pub fn record_batch(&mut self, steps_batch: Vec<(AccountId, u64)>) {
    ...
    pub fn formula(&self, steps_from_tge: U64, steps: u64) -> U128 {
    ...
    fn get_capped_steps(&mut self, account_id: &AccountId, steps_to_convert: u64) -> u64 {
        ...
        remaining_steps = i64::max(0, remaining_steps as i64 - sum as i64) as u64;
        let capped_steps: u64 = u64::min(remaining_steps, steps_to_convert);
        self.daily_limits
